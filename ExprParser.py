...
def serializedATN():
    return [
        4,1,17,69,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,
        6,2,7,7,7,1,0,5,0,18,8,0,10,0,12,0,21,9,0,1,0,1,0,1,1,1,1,1,1,1,
        1,3,1,29,8,1,1,2,1,2,1,2,1,2,1,2,1,2,1,2,1,2,1,2,1,3,1,3,1,3,1,3,
        1,3,1,3,1,3,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,4,1,5,1,5,
        1,5,1,6,1,6,1,6,1,6,1,7,1,7,1,7,1,7,1,7,0,0,8,0,2,4,6,8,10,12,14,
        0,0,64,0,19,1,0,0,0,2,28,1,0,0,0,4,30,1,0,0,0,6,39,1,0,0,0,8,46,
        1,0,0,0,10,57,1,0,0,0,12,60,1,0,0,0,14,64,1,0,0,0,16,18,3,2,1,0,
        17,16,1,0,0,0,18,21,1,0,0,0,19,17,1,0,0,0,19,20,1,0,0,0,20,22,1,
        0,0,0,21,19,1,0,0,0,22,23,5,0,0,1,23,1,1,0,0,0,24,29,3,4,2,0,25,
        29,3,8,4,0,26,29,3,6,3,0,27,29,3,10,5,0,28,24,1,0,0,0,28,25,1,0,
        0,0,28,26,1,0,0,0,28,27,1,0,0,0,29,3,1,0,0,0,30,31,5,1,0,0,31,32,
        5,2,0,0,32,33,5,14,0,0,33,34,5,3,0,0,34,35,3,12,6,0,35,36,5,4,0,
        0,36,37,3,14,7,0,37,38,5,5,0,0,38,5,1,0,0,0,39,40,5,6,0,0,40,41,
        3,12,6,0,41,42,5,4,0,0,42,43,3,14,7,0,43,44,5,7,0,0,44,45,5,14,0,
        0,45,7,1,0,0,0,46,47,5,8,0,0,47,48,5,9,0,0,48,49,5,14,0,0,49,50,
        5,3,0,0,50,51,3,12,6,0,51,52,5,4,0,0,52,53,3,14,7,0,53,54,5,4,0,
        0,54,55,5,15,0,0,55,56,5,5,0,0,56,9,1,0,0,0,57,58,5,10,0,0,58,59,
        5,14,0,0,59,11,1,0,0,0,60,61,5,13,0,0,61,62,5,11,0,0,62,63,5,13,
        0,0,63,13,1,0,0,0,64,65,5,12,0,0,65,66,5,11,0,0,66,67,5,12,0,0,67,
        15,1,0,0,0,2,19,28
    ]
...
class ExprParser ( Parser ):
    ...
    literalNames = [ "<INVALID>", "'CREATE'", "'table'", "'('", "','", "')'", 
                     "'SELECT'", "'FROM'", "'INSERT'", "'INTO'", "'DELETE'", 
                     "':'" ]
    ...
    ruleNames =  [ "prog", "expr", "create_stmt", "select_stmt", "insert_stmt", 
                   "delete_stmt", "colum_index", "row_index" ]
    ...
    def prog(self):
        ...
        try:
            ...
            while ((_la) & ~0x3f) == 0 and ((1 << _la) & 1346) != 0:
                self.state = 16
                self.expr()
                self.state = 21
                self._errHandler.sync(self)
